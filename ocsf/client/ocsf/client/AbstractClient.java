...
public abstract class AbstractClient implements Runnable {
	...
	/**
	 * Reset the object output stream so we can use the same buffer repeatedly. This
	 * would not normally be used, but is necessary in some circumstances when Java
	 * refuses to send data that it thinks has been sent.
	 */
