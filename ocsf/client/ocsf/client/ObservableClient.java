...
// ACCESSING METHODS ------------------------------------------------
	...
	/**
	 * Sets the server port number for the next connection. Only has effect if the
	...
	/**
	 * Sets the server host for the next connection. Only has effect if the client
	...
	/**
	 * This method is used to handle messages from the server. This method can be
	 * overriden but should always call notifyObservers().
	 *
	...
	/**
	 * Hook method called each time an exception is raised by the client listening
	 * thread.
	 *
